...
asr_template = '<|startoftranscription|><|{}|><|transcribe|><|{}|><|notimestamps|><|wo_itn|>'

torch.manual_seed(1234)

@entrypoint
class Qwen_audio_waitk(SpeechToTextAgent):
    def __init__(self, args: Namespace):
        ...
        self.sp_prompt = asr_template.format(self.source_lang, self.target_lang)
